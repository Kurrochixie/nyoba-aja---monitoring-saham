      ...
      h("div", { className: "dash-grid", style: { marginBottom: 18 } },
        ...
        h("div", { className: "card" },
          h("div", { className: "card-head" },
            ...
            h("button", { className: "btn btn-ghost btn-sm" }, h(Ic, { name: "plus", size: 15 }), "Tambah")),
          h("div", { style: { overflowX: "auto" } },
            h("table", { className: "tbl" },
              ...
              h("tbody", null, rows.map(function (s) {
                ...
                return h("tr", { key: s.code, className: s.code === selCode ? "selected" : "", onClick: function () { props.onSelect(s.code); } },
